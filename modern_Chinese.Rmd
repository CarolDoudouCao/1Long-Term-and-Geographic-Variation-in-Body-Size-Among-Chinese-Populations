...
```{r, include=FALSE}
# Save the plot
ggsave("combined_robust_modern_groups.tiff", plot = combined_plot, width = 6, height = 5, dpi = 600)
```
...
```{r,include=FALSE}
# Save each plot
ggsave("early_male_population_leng.png", plot = plot1, width = 10, height = 10)
ggsave("early_female_population_leng.png", plot = plot2, width = 10, height = 10)
ggsave("late_male_population_leng.png", plot = plot3, width = 7.5, height = 7.5)
ggsave("late_female_population_leng.png", plot = plot4, width = 7.5, height = 7.5)
```
...
```{r, include=FALSE}
# Save each plot
ggsave("early_male_population_bodymass.png", plot = plot1, width = 10, height = 10)
ggsave("early_female_population_bodymass.png", plot = plot2, width = 10, height = 10)
ggsave("late_male_population_bodymass.png", plot = plot3, width = 7.5, height = 7.5)
ggsave("late_female_population_bodymass.png", plot = plot4, width = 7.5, height = 7.5)
```
...
```{r, include=FALSE}
# Save each plot
ggsave("early_male_population_R_Sitting_ht.png", plot = plot1, width = 10, height = 10)
ggsave("early_female_population_R_Sitting_ht.png", plot = plot2, width = 10, height = 10)
ggsave("late_male_population_R_Sitting_ht.png", plot = plot3, width = 7.5, height = 7.5)
ggsave("late_female_population_R_Sitting_ht.png", plot = plot4, width = 7.5, height = 7.5)
```
